// Engine/Source/Runtime/WebBrowser/Private/Android/AndroidWebBrowserWidget.cpp
...
bool SAndroidWebBrowserWidget::HandleJsDialog(TSharedPtr<IWebInterfaceBrowserDialog>& Dialog)
{
	bool Retval = false;
	if (WebBrowserWindowPtr.IsValid())
	{
