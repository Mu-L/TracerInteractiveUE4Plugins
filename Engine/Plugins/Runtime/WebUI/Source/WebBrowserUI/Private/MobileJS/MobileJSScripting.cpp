// Engine/Source/Runtime/WebBrowser/Private/MobileJS/MobileJSScripting.cpp
...
namespace
{
	...
	bool WriteJsParam(FMobileJSScriptingRef Scripting, FJsonWriterRef Writer, const KeyType& Key, FWebInterfaceJSParam& Param)
	{
		switch (Param.Tag)
		{
...
void FMobileJSScripting::BindUObject(TSharedRef<class IWebInterfaceBrowserWindow> InWindow, const FString& Name, UObject* Object, bool bIsPermanent)
{
	WindowPtr = InWindow;
...
void FMobileJSScripting::UnbindUObject(TSharedRef<class IWebInterfaceBrowserWindow> InWindow, const FString& Name, UObject* Object, bool bIsPermanent)
{
	WindowPtr = InWindow;
...
void FMobileJSScripting::InvokeJSFunction(FGuid FunctionId, int32 ArgCount, FWebInterfaceJSParam Arguments[], bool bIsError)
{
	TSharedPtr<IWebInterfaceBrowserWindow> Window = WindowPtr.Pin();
	if (Window.IsValid())
	{
...
void FMobileJSScripting::InitializeScript(TSharedRef<class IWebInterfaceBrowserWindow> InWindow)
{
	WindowPtr = InWindow;
...
void FMobileJSScripting::PageLoaded(TSharedRef<class IWebInterfaceBrowserWindow> InWindow)
{
	WindowPtr = InWindow;
...
void FMobileJSScripting::SetWindow(TSharedRef<class IWebInterfaceBrowserWindow> InWindow)
{
	WindowPtr = InWindow;
}
