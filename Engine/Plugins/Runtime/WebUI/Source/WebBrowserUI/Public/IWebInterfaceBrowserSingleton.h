...
struct WEBBROWSERUI_API FBrowserContextSettings
{
...
struct WEBBROWSERUI_API FCreateBrowserWindowSettings
{
...
public:
	...
	virtual TSharedPtr<IWebInterfaceBrowserWindow> CreateBrowserWindow(const FCreateBrowserWindowSettings& Settings) = 0;
