 ...
 */
class WEBBROWSERUI_API FWebInterfaceBrowserViewport : public ISlateViewport
{
public:
	/**
	 * Default Constructor
	 ...
	 */
	FWebInterfaceBrowserViewport(TSharedPtr<IWebInterfaceBrowserWindow> InWebBrowserWindow, bool InIsPopup = false)
...
private:
	...
	TSharedPtr<IWebInterfaceBrowserWindow>	WebBrowserWindow;
