...
FName FGeometryCollectionPhysicsObject::SimplicialsAttribute("CollisionParticles");
FName FGeometryCollectionPhysicsObject::ImplicitsAttribute("Implicits");
...
DECLARE_CYCLE_STAT(TEXT("FGeometryCollectionPhysicsObject::PopulateSimulatedParticle"), STAT_PopulateSimulatedParticle, STATGROUP_Chaos);
void PopulateSimulatedParticle(FGeometryCollectionPhysicsObject::FParticlesType& Particles,
...
FGeometryCollectionPhysicsObject::FGeometryCollectionPhysicsObject(UObject* InOwner, FGeometryDynamicCollection* InDynamicCollection, FInitFunc InInitFunc, FCacheSyncFunc InCacheSyncFunc, FFinalSyncFunc InFinalSyncFunc)
	: TSolverObject<FGeometryCollectionPhysicsObject>(InOwner)
...
FGeometryCollectionPhysicsObject::~FGeometryCollectionPhysicsObject()
{
}

bool FGeometryCollectionPhysicsObject::IsSimulating() const
{
	return Parameters.Simulating;
}

void FGeometryCollectionPhysicsObject::UpdateKinematicBodiesCallback(const FParticlesType& Particles, const float Dt, const float Time, FKinematicProxy& Proxy)
{
...
void FGeometryCollectionPhysicsObject::StartFrameCallback(const float Dt, const float Time)
{
	...
	if (InitializedState == ESimulationInitializationState::Initialized)
	{
		...
		if (Parameters.IsCachePlaying() || bIsReverseCachePlaying)
		{
			...
			Chaos::FPBDRigidsSolver* ThisSolver = GetSolver();
			Chaos::FPBDRigidsSolver::FParticlesType& Particles = ThisSolver->GetRigidParticles();
			...
			if (!bIsReverseCachePlaying)
			{
				...
				if (RecordedFrame)
				{
					...
					if (Parameters.CollisionData.DoGenerateCollisionData && ThisFrameTime > 0.f && Parameters.CollisionData.CollisionDataSizeMax > 0)
					{
						...
						{
							Chaos::FPBDRigidsSolver::FCollisionDataArray& AllCollisionsDataArray = ThisSolver->GetAllCollisionsDataArray();
							TMap<ISolverObjectBase*, TArray<int32>>& AllCollisionsIndicesBySolverObject = ThisSolver->GetAllCollisionsIndicesBySolverObject();

							if (!AllCollisionsIndicesBySolverObject.Contains(this))
							{
								AllCollisionsIndicesBySolverObject.Add(this, TArray<int32>());
							}
							...
							for (int32 Idx = 0; Idx < RecordedFrame->Collisions.Num(); ++Idx)
							{
									...
									(RecordedFrame->Collisions[Idx].ParticleIndex >= 0 && RecordedFrame->Collisions[Idx].ParticleIndex < static_cast<int32>(Particles.Size()) && Particles.ObjectState(RecordedFrame->Collisions[Idx].ParticleIndex) == Chaos::EObjectStateType::Kinematic))
								{
									...
									AllCollisionsIndicesBySolverObject[this].Add(NewIdx);
								}
							}
						}
					}
					...
					if (Parameters.BreakingData.DoGenerateBreakingData && ThisFrameTime > 0.f && Parameters.BreakingData.BreakingDataSizeMax > 0)
					{
						...
						{
							Chaos::FPBDRigidsSolver::FBreakingDataArray& AllBreakingsDataArray = ThisSolver->GetAllBreakingsDataArray();
							TMap<ISolverObjectBase*, TArray<int32>>& AllBreakingsIndicesBySolverObject = ThisSolver->GetAllBreakingsIndicesBySolverObject();

							if (!AllBreakingsIndicesBySolverObject.Contains(this))
							{
								AllBreakingsIndicesBySolverObject.Add(this, TArray<int32>());
							}
							...
							for (int32 Idx = 0; Idx < RecordedFrame->Breakings.Num(); ++Idx)
							{
									...
									(RecordedFrame->Breakings[Idx].ParticleIndex >= 0 && RecordedFrame->Breakings[Idx].ParticleIndex < static_cast<int32>(Particles.Size()) && Particles.ObjectState(RecordedFrame->Breakings[Idx].ParticleIndex) == Chaos::EObjectStateType::Kinematic))
								{
									...
									AllBreakingsIndicesBySolverObject[this].Add(NewIdx);
								}
							}
						}
					}
					...
					if (Parameters.TrailingData.DoGenerateTrailingData && ThisFrameTime > 0.f && Parameters.TrailingData.TrailingDataSizeMax > 0)
					{
						...
						{
							Chaos::FPBDRigidsSolver::FTrailingDataArray& AllTrailingsDataArray = ThisSolver->GetAllTrailingsDataArray();
							TMap<ISolverObjectBase*, TArray<int32>>& AllTrailingsIndicesBySolverObject = ThisSolver->GetAllTrailingsIndicesBySolverObject();

							if (!AllTrailingsIndicesBySolverObject.Contains(this))
							{
								AllTrailingsIndicesBySolverObject.Add(this, TArray<int32>());
							}
							...
							for (const FSolverTrailingData& Trailing : RecordedFrame->Trailings)
							{
									...
									(Trailing.ParticleIndex >= 0 && Trailing.ParticleIndex < static_cast<int32>(Particles.Size()) && Particles.ObjectState(Trailing.ParticleIndex) == Chaos::EObjectStateType::Kinematic))
								{
									...
									AllTrailingsIndicesBySolverObject[this].Add(NewIdx);
								}
							}
						}
					}
...
void FGeometryCollectionPhysicsObject::EndFrameCallback(const float EndFrame)
{
	if (InitializedState == ESimulationInitializationState::Initialized)
	{
		FGeometryDynamicCollection* Collection = Parameters.DynamicCollection;
...
void FGeometryCollectionPhysicsObject::CreateRigidBodyCallback(FParticlesType& Particles)
{
...
void FGeometryCollectionPhysicsObject::ActivateBodies()
{
...
void FGeometryCollectionPhysicsObject::BindParticleCallbackMapping(Chaos::TArrayCollectionArray<SolverObjectWrapper> & SolverObjectReverseMap, Chaos::TArrayCollectionArray<int32> & ParticleIDReverseMap)
{
	if (InitializedState== ESimulationInitializationState::Initialized)
	{
		for (int32 Index = 0; Index < RigidBodyID.Num(); Index++)
		{
			...
			if (RigidBodyIndex != INDEX_NONE)
			{
				SolverObjectReverseMap[RigidBodyIndex] = {this, ESolverObjectType::GeometryCollectionType};
...
void FGeometryCollectionPhysicsObject::ContiguousIndices(TArray<ContextIndex>& Array, const Chaos::FPBDRigidsSolver* RigidSolver, EFieldResolutionType ResolutionType, bool bForce = true)
{
	if (bForce)
	{
...
void FGeometryCollectionPhysicsObject::ProcessCommands(FParticlesType& Particles, const float Time)
{
	FGeometryDynamicCollection* Collection = Parameters.DynamicCollection;
	check(Collection);
	...
	if (Commands.Num())
	{
		...
		Chaos::FPBDRigidsSolver* CurrentSolver = GetSolver();
		...
		for (int32 CommandIndex = Commands.Num()-1; 0<=CommandIndex; CommandIndex--)
		{
			...
			if (Command.TargetAttribute == GetGeometryCollectionPhysicsTypeName(EGeometryCollectionPhysicsTypeEnum::Chaos_DynamicState))
			{
				...
				{
					FGeometryCollectionPhysicsObject::ContiguousIndices(IndicesArray, CurrentSolver, ResolutionType, IndicesArray.Num() != Particles.Size());
					if (IndicesArray.Num())
					{
...
void FGeometryCollectionPhysicsObject::PushKinematicStateToSolver(FParticlesType& Particles)
{
	if (InitializedState == ESimulationInitializationState::Initialized)
	{
		FGeometryDynamicCollection* Collection = Parameters.DynamicCollection;
...
void FGeometryCollectionPhysicsObject::ParameterUpdateCallback(FParticlesType& Particles, const float Time)
{
	if (InitializedState == ESimulationInitializationState::Initialized)
	{
		FGeometryDynamicCollection* Collection = Parameters.DynamicCollection;
...
void FGeometryCollectionPhysicsObject::DisableCollisionsCallback(TSet<TTuple<int32, int32>>& InPairs)
{

}

void FGeometryCollectionPhysicsObject::AddForceCallback(FParticlesType& InParticles, const float InDt, const int32 InIndex)
{
	// gravity forces managed directly on the solver for now
}

void FGeometryCollectionPhysicsObject::FieldForcesUpdateCallback(Chaos::FPBDRigidsSolver* InSolver, FParticlesType& Particles, Chaos::TArrayCollectionArray<FVector> & Force, Chaos::TArrayCollectionArray<FVector> & Torque, const float Time)
{
	if (InitializedState == ESimulationInitializationState::Initialized)
	{
		if (Commands.Num())
...
void FGeometryCollectionPhysicsObject::Initialize()
{
	// Old proxy init
...
void FGeometryCollectionPhysicsObject::Reset()
{
	InitializedState = ESimulationInitializationState::Unintialized;
}
...
DECLARE_CYCLE_STAT(TEXT("FGeometryCollectionPhysicsObject::BuildClusters"), STAT_BuildClusters, STATGROUP_Chaos);
DECLARE_CYCLE_STAT(TEXT("FGeometryCollectionPhysicsObject::BuildClusters:GlobalMatrices"), STAT_BuildClustersGlobalMatrices, STATGROUP_Chaos);
void FGeometryCollectionPhysicsObject::BuildClusters(uint32 CollectionClusterIndex, const TArray<uint32>& CollectionChildIDs, const TArray<uint32>& ChildIDs, const Chaos::FClusterCreationParameters<float> & ClusterParameters)
{
...
int32 FGeometryCollectionPhysicsObject::CalculateHierarchyLevel(FGeometryDynamicCollection* GeometryCollection, int32 TransformIndex)
{
	int32 Level = 0;
...
void FGeometryCollectionPhysicsObject::CreateDynamicAttributes()
{
	const FGeometryCollection& RestCollection = *Parameters.RestCollection;
	FGeometryDynamicCollection* DynamicCollection = Parameters.DynamicCollection;
...
void FGeometryCollectionPhysicsObject::InitializeSharedCollisionStructures(Chaos::FErrorReporter& ErrorReporter, FGeometryCollection& RestCollection, const FSharedSimulationParameters& SharedParams)
{
...
void FGeometryCollectionPhysicsObject::InitRemoveOnFracture(FGeometryCollection& RestCollection, const FSharedSimulationParameters& SharedParams)
{
...
void FGeometryCollectionPhysicsObject::InitializeKinematics(FParticlesType& Particles, const TManagedArray<int32>& DynamicState)
{
...
void FGeometryCollectionPhysicsObject::InitializeRemoveOnFracture(FParticlesType& Particles, const TManagedArray<int32>& DynamicState)
{
...
void FGeometryCollectionPhysicsObject::MergeRecordedTracks(const FRecordedTransformTrack& A, const FRecordedTransformTrack& B, FRecordedTransformTrack& Target)
{
...
FRecordedFrame& FGeometryCollectionPhysicsObject::InsertRecordedFrame(FRecordedTransformTrack& InTrack, float InTime)
{
...
void FGeometryCollectionPhysicsObject::AddCollisionToCollisionData(FRecordedFrame* ExistingFrame, const FParticlesType& Particles, const Chaos::TPBDCollisionConstraint<float, 3>::FRigidBodyContactConstraint& Constraint)
{
	...
	const Chaos::TArrayCollectionArray<SolverObjectWrapper>& SolverObjectReverseMapping = GetSolver()->GetSolverObjectReverseMapping();
...
void FGeometryCollectionPhysicsObject::UpdateCollisionData(const FParticlesType& Particles, const FCollisionConstraintsType& CollisionRule, FRecordedFrame* ExistingFrame)
{
	...
	if (Parameters.CollisionData.SaveCollisionData && ExistingFrame->Timestamp > 0.f && Parameters.CollisionData.CollisionDataSizeMax > 0)
	{
		...
		if (AllConstraintsArray.Num() > 0)
		{
			...
			{
				// Check if the collision is for this PhysicsObject
				ISolverObjectBase* SolverObject = SolverObjectReverseMapping[AllConstraintsArray[Idx].ParticleIndex].SolverObject;
				if (SolverObject == this)
				{
...
void FGeometryCollectionPhysicsObject::AddBreakingToBreakingData(FRecordedFrame* ExistingFrame, const FParticlesType& Particles, const Chaos::TBreakingData<float, 3>& Breaking)
{
	const Chaos::TArrayCollectionArray<Chaos::ClusterId>& ClusterIdsArray = GetSolver()->GetRigidClustering().GetClusterIdsArray();
	const TMap<uint32, TUniquePtr<TArray<uint32>>>& ParentToChildrenMap = GetSolver()->GetRigidClustering().GetChildrenMap();
	const Chaos::TArrayCollectionArray<SolverObjectWrapper>& SolverObjectReverseMapping = GetSolver()->GetSolverObjectReverseMapping();
...
void FGeometryCollectionPhysicsObject::UpdateBreakingData(const FParticlesType& Particles, FRecordedFrame* ExistingFrame)
{
	...
	if (Parameters.BreakingData.SaveBreakingData && ExistingFrame->Timestamp > 0.f && Parameters.BreakingData.BreakingDataSizeMax > 0)
	{
		...
		if (AllBreakingsArray.Num() > 0)
		{
			...
			{
				// Check if the breaking is for this PhysicsObject
...
void FGeometryCollectionPhysicsObject::UpdateTrailingData(const FParticlesType& Particles, FRecordedFrame* ExistingFrame)
{
	...
	if (Parameters.TrailingData.SaveTrailingData && ExistingFrame->Timestamp > 0.f && Parameters.TrailingData.TrailingDataSizeMax > 0)
	{
		...
		if (ExistingFrame->Trailings.Num() < Parameters.TrailingData.TrailingDataSizeMax)
		{
			...
			{
				// Check if the particle is for this PhysicsObject
...
void FGeometryCollectionPhysicsObject::UpdateRecordedState(float SolverTime, const TManagedArray<int32>& InRigidBodyID, const TManagedArray<int32>& InCollectionClusterID, const Chaos::TArrayCollectionArray<bool>& InInternalCluster, const FParticlesType& Particles, const FCollisionConstraintsType& CollisionRule)
{
...
void FGeometryCollectionPhysicsObject::OnRemoveFromScene()
{
...
void FGeometryCollectionPhysicsObject::SyncBeforeDestroy()
{
	if(FinalSyncFunc)
	{
...
void FGeometryCollectionPhysicsObject::CacheResults()
{
	using namespace Chaos;
...
void FGeometryCollectionPhysicsObject::FlipCache()
{
	Results.Flip();
}

void FGeometryCollectionPhysicsObject::SyncToCache()
{
...
void BuildSimulationData(Chaos::FErrorReporter& ErrorReporter, FGeometryCollection& GeometryCollection, const FSharedSimulationParameters& SharedParams)
{
	...
	FGeometryCollectionPhysicsObject::InitializeSharedCollisionStructures(ErrorReporter, GeometryCollection, SharedParams);
}
